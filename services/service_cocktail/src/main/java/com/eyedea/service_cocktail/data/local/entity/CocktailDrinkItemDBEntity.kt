...
data class CocktailDrinkItemDBEntity(
    ...
    val strIBA: String? = "",
    @ColumnInfo(name = "strImageAttribution")
    ...
    val video: String? = "",
    @ColumnInfo(name = "drinkId") @PrimaryKey(autoGenerate = false)
    val drinkId: Long,
) {
    ...
    data class IngredientsItemDBData(
        ...
        @ColumnInfo(name = "ingredientId") @PrimaryKey(autoGenerate = true) val id: Long? = null
    )
}
